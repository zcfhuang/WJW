...
class ItemBasedCF:
    ...
    def __init__(self, k_sim_movie=10, n_rec_movie=5, use_iuf_similarity=False, save_model=False):
        """
    ...
    def test(self, testset,logger):
        ...
        test_time.finish()
        logger.info('precision=%.4f\trecall=%.4f\tcoverage=%.4f\tpopularity=%.4f\n' %
